...
export const patientAPI = {
  ...
  updateEmergencyContact: (id, data) => api.put(`/patients/emergency-contacts/${id}`, data),
  deleteEmergencyContact: (id) => api.delete(`/patients/emergency-contacts/${id}`),
  updateHealthCategories: (categories) => api.put('/patients/health-categories', { categories }),
};
